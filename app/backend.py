...
class VoiceAssistant:
    ...
    def run(self):
        ...
        while self.running:
            ...
            GENERAL RULES:
            - Always respond in the SAME language the user speaks to you (English, Hindi, Tamil, Kannada, Malayalam, Telugu, Marathi, or Spanish).
            - If you speak in an Indian language, you MUST use the NATIVE SCRIPT (e.g., Devanagari for Hindi/Marathi, Telugu script for Telugu, Tamil script for Tamil).
            - If you speak in Spanish, you MUST use standard Spanish with correct punctuation (¿, ¡, ñ).
            - NEVER use Romanized English (like 'Namaskara') for Indian languages.
